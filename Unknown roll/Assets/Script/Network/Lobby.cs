...
all'interno vi sono tutte le funzioni per poter accedere alla lista e modificarla così da centralizzare tutto l'utilizzo di tale classe in questo unico file.
*/
...
public class Lobby : MonoBehaviour
{
    ...
    public void Check_Connection(Socket User)
    {
        ...
        try
        {
            send.Send_to_One(send.Lobby_Ping(), User, "Check connection failed");
        }
        catch(Exception e)
        {
